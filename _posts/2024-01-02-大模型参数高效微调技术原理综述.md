...
![img](img/LLM-PEFT/peft_type.png)
...
- ![img](img/LLM-PEFT/lora_main_method.jpg)
- 技术原理：
...
- 可以通过可插拔的形式切换到不同的任务
- ![img](img/LLM-PEFT/lora_example.png)
...
- ![img](img/LLM-PEFT/mam_adapter_example.jpg)
- ![img](img/LLM-PEFT/mam_adapter_experiment.png)
- **具体实现**
...
- 对不同 PELT 方法训练时间和推理时间进行了分析
  ...
  - ![img](img/LLM-PEFT/unipeft_experiment.png)
...
- ![img](img/LLM-PEFT/cpd.png)
- **Tucker分解**：计算复杂度比较大
  - ![img](img/LLM-PEFT/tuckerd.png)
...
- 实验结果
  - 图文检索
    - ![img](img/LLM-PEFT/aurora-itr.png)
  - 视频文本检索
    - ![img](img/LLM-PEFT/aurora-vtr.png)
  - VQA
    - ![img](img/LLM-PEFT/aurora-vqa.png)
